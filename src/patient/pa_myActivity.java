...
public class pa_myActivity {
	...
	@Parameters({"url"})
	@Test(priority=1)
	public void testMyActivity_LinkFunct(String url){
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		//pu.assert_text("My Activity");
		System.out.println("********** My Activity Link Present **********");
	}
	
	@Parameters({"url"})
	@Test(priority=2)
	public void testmyActivity_QuestionsPresent(String url){
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		if(selenium.isElementPresent(objWrite.WriteObjectRepo("pat_activity_1st_que"))){
			System.out.println("Questions present in My Activity");
		}
		else{
			System.out.println("No Questions in My Activity");
		}
	}
	...
	@Parameters({"url"})
	@Test(priority=3)
	public void TestAnsweredQuestionDetails(String url) throws InterruptedException{
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		if(selenium.isElementPresent(objWrite.WriteObjectRepo("pat_activity_1st_que"))){
		Thread.sleep(1000);
		if(selenium.getText(objWrite.WriteObjectRepo("answered")).contains("answered"))
		{
				selenium.click(objWrite.WriteObjectRepo("pat_activity_1st_que"));
				Thread.sleep(2000);
				assertTrue(selenium.isElementPresent(objWrite.WriteObjectRepo("que_ans")));
				System.out.println("On question deatils page");
		}
		else
			{
				System.out.println("NO answered question present");
			}					
		}
		else{
			System.out.println("No Questions in My Activity");
	...
	@Parameters({"url"})
	@Test(priority=4)
	public void TestThankDoctor(String url) throws InterruptedException
	{
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		if(selenium.isElementPresent(objWrite.WriteObjectRepo("pat_activity_1st_que"))){
			Thread.sleep(1000);
	...
	@Parameters({"url"})
	@Test(priority=5)
	public void ShareFacebook(String url) throws InterruptedException
	{
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		if(selenium.isElementPresent(objWrite.WriteObjectRepo("pat_activity_1st_que"))){
			Thread.sleep(1000);
	...
	@Parameters({"url"})
	@Test(priority=6)
	public void TwitterShare(String url) throws InterruptedException
	{
		driver.findElement(By.xpath(objWrite.WriteObjectRepo("pat_activity_link"))).click();
		if(selenium.isElementPresent(objWrite.WriteObjectRepo("pat_activity_1st_que"))){
			Thread.sleep(1000);
